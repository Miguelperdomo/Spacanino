...
$sql="SELECT  * from auxvet where id_aux=:co";//consulta con marcador, el marcador es :codigo
...
$resultado->execute(array(":co"=>$busca));
	...
	if($administrador=$resultado->fetch(PDO::FETCH_ASSOC)){
		...
		<h4 class="titulo1">¿Seguro quieres Eliminar este Auxiliar Vet.?</h4>
		<br>
		<table class="principal">
            ...
            <tr>
				...
				<td class="titulo">
					<input type="text"  class="in" readonly name="doc" value="<?php echo $administrador['id_aux']?>" readonly>
				</td>
			</tr>
