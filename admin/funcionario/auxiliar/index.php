<?php
    ...
    $regis=$base->query("SELECT * from auxvet LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
        ...
        if(isset($_GET['insert'])){
            ...
            $sql="INSERT INTO auxvet (id_aux, id_rol, name, adress, cel) values (:id, :ro, :nam, :adr, :cel)";
            $resultado=$base->prepare($sql);
            $resultado->execute(array(":id"=>$idu, ":ro"=>$rol, ":nam"=>$name, ":adr"=>$direccion,":cel"=>$tel));
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
     ...
     <!-- Título -->
    <div class="title">
        <h3 class="text-center">Registro Auxiliares veterinarios</h3>
    </div>
     <!-- Tabla + Formulario -->
    <div class="container">
                ...
                <table class="table table-bordered table-striped ">
                    ...
                    <tbody class="text-center bordered">
                        ...
                        <tr class="table-light" >
                            <td><?php echo $administrador->id_aux?></td>
							...
							<td>
                                <a href="editar.php?id=<?php echo $administrador->id_aux?> & nom=<?php echo $administrador->name?>  & dir=<?php echo $administrador->adress?>"><button type="button" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></button></a>
                            </td>
                            <td>
                                <a href="eliminar.php?id=<?php echo $administrador->id_aux?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                            </td>
                        <?php
                            endforeach;
                        ?>
