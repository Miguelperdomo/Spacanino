            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="panel panel-primary">
                        <a href="./admin/index.php"><div class="panle-body"><img src="../../img/admin.png" class="img-responsive" alt="Image" style="width: 100%;"></div>Administrador</a>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="panel panel-primary">
                        <a href="auxiliar/index.php"><div class="panle-body"><img src="../../img/auxvet.png" class="img-responsive" alt="Image" style="width: 100%;"></div>Auxiliar Veterinario</a>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="panel panel-primary">
                        <a href="Recep/index.php"><div class="panle-body"><img src="../../img/recep.png" class="img-responsive" alt="Image" style="width: 100%;"></div>Recepcionista</a>
                    </div>
                </div>
            </div>
        </div> 
