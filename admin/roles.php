<?php
    ...
    $regis=$base->query("SELECT * from roles LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
        ...
        if(isset($_GET['insert'])){
            ...
            $sql="INSERT INTO roles (id_rol, role) values (:id, :ro)";
            $resultado=$base->prepare($sql);
            $resultado->execute(array(":id"=>$idu, ":ro"=>$role));
                ...
                <table class="table table-bordered table-striped ">
                    ...
                    <tbody class="text-center bordered">
                        ...
                        <tr class="table-light" >
							...
							<td>
                                <a href="roles/editar.php?id=<?php echo $roles->id_rol?> & rol=<?php echo $roles->role?>"><button type="button" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></button></a>
                            </td>
                            <td>
                                <a href="roles/eliminar.php?id=<?php echo $roles->id_rol?> & rol=<?php echo $roles->role?> "><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                            </td>
                        <?php
                            endforeach;
                        ?>
                        ...
                        <tr class="table-light" >
                            ...
                            <td><input type="text" name="ser" class="form-control" placeholder="Nombre Rol"></td>
