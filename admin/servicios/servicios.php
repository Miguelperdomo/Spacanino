                ...
                <table class="table table-bordered table-striped ">
                    ...
                    <tbody class="text-center bordered">
                        ...
                        <tr class="table-light" >
							...
							<td>
                                <a href="editar.php?id=<?php echo $servicios->id_ser?> & ser=<?php echo $servicios->servicio?>  & pre=<?php echo $servicios->precio?>"><button type="button" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></button></a>
                            </td>
                            <td>
                                <a href="eliminar.php?id=<?php echo $servicios->id_ser?>"><button type="button" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash-can"></i></button></a>
                            </td>
                        <?php
                            endforeach;
                        ?>
                                ...
                                <ul class="pagination justify-content-center">
                                    ...
                                    <?php
                                        for($i=0; $i<$paginas; $i++):?>
                                            ...
                                            <?php endfor?>
                                    <li class="page-item <?php  echo $pagina>=$paginas? 'disabled' : '' ?> "><a class="page-link" href="servicios.php?pagina=<?php echo $pagina+1 ?>">Next</a></li>
                                </ul>
                            </nav>
                        </tr>
                        <tr class="table-light" >
