...
$sql="SELECT  * from servicios where id_ser=:co";
...
$resultado->execute(array(":co"=>$busca));
	...
	if($servicio=$resultado->fetch(PDO::FETCH_ASSOC)){
		
		?>
<form action="./validareliminar.php" method="get">
	<div class="container">
		<h4 class="titulo1">¿Seguro quieres Eliminar esta Este servicio?</h4>
		<br>
		<table class="principal">
			
            <tr>
			 	<th class="ti"> Consecutivo </th>
				<td class="titulo">
					<input type="text"  class="in" readonly name="con" value="<?php echo $servicio['id_ser']?>" readonly>
				</td>
			</tr>
			
            <tr>
				<th class="ti"> Nombre del servicio </th>
				<td class="titulo">
					<input type="text"  class="in" name="ser" value="<?php echo $servicio['servicio']?>" readonly>
				</td>
			</tr>
            ...
            <tr>
				...
				<td class="titulo">
					<input type="text"  class="in" name="pre" value="<?php echo $servicio['precio']?>" readonly>
				</td>
			</tr>
            <tr>
		...
		<td colspan="2" align="center">
			<a href="../servicios.php"><button type="button" class="enviar2">Cancelar</button></a>
		</td>
		</div>
	</form>
