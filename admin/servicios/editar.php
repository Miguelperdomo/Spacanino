...
<form action="validareditar.php" method="get">
	<div class="container">
		<h4 class="titulo1">¿Vas a Actualizar este servicio?</h4>
		<br>
		<table class="principal">
            <tr>
			 	<th class="ti">Consecutivo</th>
				<td  class="titulo">
					<input type="text" class="in" readonly name="con" value="<?php echo $servicio['id_ser']?>">
				</td>
			</tr>
            ...
            <tr>
				...
				<td  class="titulo">
					<input type="text" class="in" name="ser" value="<?php echo $servicio['servicio']?>">
				</td>
			</tr>
            ...
            <tr>
				...
				<td  class="titulo">
					<input type="text" class="in" name="pre" value="<?php echo $servicio['precio']?>">
				</td>
			</tr>
            <tr>
