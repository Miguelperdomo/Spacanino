<?php
    ...
    $regis=$base->query("SELECT * from users WHERE id_rol = 4 LIMIT $empieza, $regis")->fetchALL(PDO::FETCH_OBJ);
...
<body>
    ...
    <div class="title">
        <h3 class="text-center">Registro Dueños</h3>
    </div>
     <!-- Tabla + Formulario -->
    <div class="container">
                            ...
                            <td>
                                <div class="input-group">
                                    <select class="custom-select" name="rol">
                                        ...
                                        <?php
                                        $sql= "SELECT * FROM roles where id_rol = 4"; 
                                        $resultado=$base->prepare($sql);
