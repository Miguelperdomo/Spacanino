...
try{
	...
	if($registr=$resultado->fetch(PDO::FETCH_ASSOC)){
		...
		if(isset($_GET['eliminar'])){
			...
			$sql="DELETE FROM mascotas WHERE id_mas=:id";
			...
			echo '<script>alert("Haz Eliminado esta Mascota, Yuju!");</script>';
			...
			<form method="GET">
				...
				<h4 class="titulo1">¿Vas a Eliminar esta Mascota?</h4>
			<br>
			<table class="principal">
				<tr>
					<th class="ti">Id</th>
					<td  class="titulo">
						<input type="text" readonly class="in" name="id" value="<?php echo $registr['id_mas']?>">
					</td>
				</tr>
				...
				<tr>
					...
					<td  class="titulo">
						<input type="text" readonly class="in" name="tp" value="<?php echo $registro['pet'] ?>">
					</td>
				</tr>
				...
				<tr>
					...
					<td  class="titulo">
						<input type="text" readonly class="in" name="nom" value="<?php echo $registr['namepet']?>">
					</td>
				</tr>
				...
				<tr>
					<th class="ti">Raza</th>
					<td  class="titulo">
						<input type="text" readonly class="in" name="corr" value="<?php echo $re['raza']?>">
					</td>
				</tr>
				...
				<tr>
					...
					<td  class="titulo">
						<input type="text" readonly class="in"  name="usu" value="<?php echo $registr['color']?>">
					</td>
				</tr>	
				...
				<tr>
					...
					<td  class="titulo">
						<input type="text" readonly class="in" name="usua" value="<?php echo $reg['name']?>">
					</td>
				</tr>		
				<tr>
					<td colspan="2" align="center">
						<br>
						<input class="enviar" type="submit" name="eliminar" id="ingresa" value="Eliminar">
					</td>
				</tr>
			</table>
			<br>
